...
def add_moving_averages(input_file, output_file=None):
    ...
    for period in ma_periods:
        ...
        print(f"Added MA_{period}")

    # Round moving averages to reasonable decimal places
    ma_columns = [f'ma_{period}' for period in ma_periods]
    ...
    print(
        f"Date range: {df['timestamp'].min()} to {df['timestamp'].max()}" if 'timestamp' in df.columns else "No timestamp column")
...
def main():
    ...
    """
    # Your file paths
    input_file = "C:/Users/Hayden/LSTM/alpaca/nvda_5min.csv"
    output_file = "C:/Users/Hayden/LSTM/alpaca/nvda_5minla.csv"
    ...
    if result_df is not None:
        ...
        print("The new columns are: ma_5, ma_10, ma_20, ma_40, ma_55")
